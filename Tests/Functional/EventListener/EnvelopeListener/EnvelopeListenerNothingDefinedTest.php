...
final class EnvelopeListenerNothingDefinedTest extends AbstractEnvelopeListenerTestCase
{
    ...
    public function test(): void
    {
        ...
        self::assertEquals(
            [new Address('max.mustermann@domain.com'), new Address('some.mustermann@domain.com')],
